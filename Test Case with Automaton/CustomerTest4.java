...
//	verify adding customer details with only  with alphabet letters firstname :- john      lastname :- walker zip/pncode - ohio	
	...
	public void addcustomerdetail() throws InterruptedException {
	   ...
	   CustomerDpage.firstname("john");
	   
	   CustomerDpage.Lastname("walker");
	   
	   CustomerDpage.PostalCode("ohio");
